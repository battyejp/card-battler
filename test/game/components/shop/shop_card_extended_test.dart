...
void main() {
  group('ShopCard Component - Extended Functionality', () {
    group('constructor and inheritance', () {
    ...
    group('face-up display functionality', () {
    ...
    group('face-down display functionality', () {
